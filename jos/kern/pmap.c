...
boot_alloc(uint32_t n)
{
	...
	size_t MAX_ADDR = npages*PGSIZE;	//  = 0x 0800 0000
		...
		// A co nam vlastne urcuje npages ? (odkial mame to cislo)? 
...
// na vstupe ma funkcia smernik na page dir (urcuje virtual adresny priestor)
//  a virtualnu 32bit adresu 
// vracia adresu polozky v page tbl, ktora zodpoveda vstupnej va, 
...
//	*PD_entry = pgdir[PDX(va)];	// to iste ? (nastane pamatova chyba, nie ?)
	...
	// ak hodnota zaznamu pde je platna (je nastaveny bit PTE_P)
	// mozeme vratit adresu zaznamu vo formate (pte_t*) 
